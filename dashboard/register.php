...
<head>
    <meta charset="utf-8" />
    <title>Dashboard Register - Pixel Coders | Web Designers &amp; Web Developers | Category Product based website Designs |India</title>
...
<body class="">
    ...
    <div class="login"><div class="container">
        ...
        <div class=" col-xs-12 col-sm-6 col-md-4 col-lg-4 col-sm-offset-3 col-md-offset-4 col-lg-offset-4">
            <div class="well row">
                <h2 class="text-center"><span>Pixel Coders</span>Dashboard Register</h2><br>
                <form class="form row" method="post" action="register.php">
                  <div class="form-group row">
                        <div class="input-wrap col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="" placeholder="First Name" name="mem_first" required>
                  ...
                  <div class="form-group row">
                        <div class="input-wrap col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" class="" placeholder="Last Name" name="mem_last" required>
                            <span class="morph-shape" data-morph-active="M359,70c0,0-59,6-174,6C84,76,9,70,9,70S3,60,3,40c0-16,6-30,6-30s75-6,176-6c115,0,174,6,174,6s8,14,8,30C367,60,359,70,359,70z">
                                <svg width="100%" height="100%" viewBox="0 0 370 80" preserveAspectRatio="none">
                                    <path d="M359,70c0,0-59,0-174,0C84,70,9,70,9,70s0-10,0-30c0-16,0-30,0-30s75,0,176,0c115,0,174,0,174,0s0,14,0,30C359,60,359,70,359,70z"/>
                                </svg>
                    ...
                    error_reporting(E_ALL & ~E_NOTICE);
                        ...
                        if ($_POST['register']){
                            ...
                            $firstname= strip_tags($_POST['mem_first']);
                            $lastname = strip_tags($_POST['mem_last']);
                            $username = strip_tags($_POST['username']);
                            $password = strip_tags($_POST['password']);

                            $storepassword = password_hash($password, PASSWORD_BCRYPT, array('cost' => 14));

                            $sql = "INSERT INTO members (username, password, firstname, lastname) values ('{$username}','{$storepassword}','{$firstname}','{$lastname}')";
                    ...
                    <input type="submit" name="register" class="btn btn-info btn-lg btn-block" value="Create User"></input>
                </form>
            </div>
        </div>
    </div></div>
