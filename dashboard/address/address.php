                ...
                <div class="list row">
                    ...
                    if (mysqli_num_rows($result) > 0)
                    {
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<abbr title="Phone">Phone: </abbr>'.$row["addr_numb"].'<br>';
                            echo '</address>';
                            echo '<address>';
                            ...
                            echo '<a href="javascript:void(0)"><i class="list-fa btn fa fa-trash del-addr" id="'.$row["addr_id"].'"></i></a><br><hr><br></div>';
                        }
                    }
            ...
            <div class="set">
                ...
                <form class="edit row" name="socialadd" >
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12"><hr>
                        <a href="javascript:void(0)" name="submit" id="add-social" class="btn btn-default">Create Social Link</a>
                    </div>
                </form>
            </div>
            <br>
