                ...
                <table class="table table-hover" id="sort-table"> 
                    ...
                    if (mysqli_num_rows($result) > 0)
                    {
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td><a href="updateprod.php?id='.$row["prd_id"].'"><i class="fa fa-pencil-square-o" id="'.$row["prd_id"].'"></i></a></td>';
    ...
    $(document).ready(function() {
        ...
        $(".prod-del").click(function() {
            ...
            if (confirm("Sure you want to delete this Product? This cannot be undone later. \n")) {
                $.ajax({
                    type : "POST",
                    url : "deleteprod.php", //URL to the delete php script
                    data : { "prodid" : del_id},
                    success : function() {
                    }
                });
        ...
        $(".prod-edit").click(function() {
            ...
            if (confirm("Sure you want to Edit this Product? \n")) {
                $.ajax({
                    type : "POST",
                    url : "editprod.php", //URL to the delete php script
