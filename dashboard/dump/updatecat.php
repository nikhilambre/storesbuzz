    ...
    <div class="dash-wrap row">
        ...
        <div class="create row">
            <div class="set">
                ...
                <form class="edit row" name="catform" action="updatecatdone.php" method="post" enctype="multipart/form-data">

                    <div class="form-group row hidden">
                      <label for="exampleInputEmail1" class="col-xs-12 col-sm-2 col-md-2 col-lg-2"></label>
                      <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
                          <input type="text" class="form-control" name="cat_id" maxlength="78" value="<?php echo $val ?>">
                      </div>
                    </div>
