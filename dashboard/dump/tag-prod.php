    ...
    <div class="dash-wrap row">
        ...
        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
            <div class="set">
                ...
                <form class="edit row" name="tagform" method="POST" action="tag-save.php" enctype="multipart/form-data">
    ...
    $(document).ready(function() {
        ...
        $("#add-tag").click(function() {
            ...
            if (name) {
                $.ajax({
                    type : "POST",
                    url : "tag-add.php", //URL to the delete php script
                    data : { "tagname" : name},
                    success : function() {
        ...
        $(".edit-tag").click(function() {
            ...
            if (tag_name) {
                if (confirm("Sure you want to Edit this Tag? \n")) {
                    $.ajax({
                        type : "POST",
                        url : "edittag.php", //URL to the delete php script
        ...
        $(".del-tag").click(function() {
            ...
            if (confirm("Sure you want to Delete this Tag? \n")) {
                $.ajax({
                    type : "POST",
                    url : "deletetag.php", //URL to the delete php script
                    data : { "tagid" : del_id},
                    success : function() {
        ...
        $("#prod_id").change(function (){
            ...
            $.ajax({
                type : "POST",
                url : "tag-show.php", //URL to the delete php script
