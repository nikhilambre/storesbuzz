                ...
                <table class="table table-hover" id="sort-table"> 
                    ...
                    if (mysqli_num_rows($result) > 0)
                    {
                        ...
                        while($row = mysqli_fetch_assoc($result)) {
                            ...
                            echo '<td><a href="updatecat.php?id='.$row["cat_id"].'"><i class="fa fa-pencil-square-o" id="'.$row["cat_id"].'"></i></a></td>';
    ...
    $(document).ready(function() {
        ...
        $(".cat-del").click(function() {
            ...
            if (confirm("Sure you want to delete this Category? This cannot be undone later. \n")) {
                $.ajax({
                    type : "POST",
                    url : "deletecat.php", //URL to the delete php script
                    data : { "catid" : del_id},
                    success : function() {
                    }
                });
        ...
        $(".cat-edit").click(function() {
            ...
            if (confirm("Sure you want to Edit this Category? \n")) {
                $.ajax({
                    type : "POST",
                    url : "editcat.php", //URL to the delete php script
